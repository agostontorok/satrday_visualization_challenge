...
file.rename("eZ76jcu.png", "Generic_turbofan_airplane.png")
img <- rasterGrob(readPNG("Generic_turbofan_airplane.png"), 0, 0, 1, 1, just=c("left","bottom"))
...
qplot(1:10, 1:10, geom="blank") +
  annotation_custom(airport, xmin=-Inf, xmax=Inf, ymin=-Inf, ymax=Inf) +
  geom_point()
